...
var reply = document.querySelectorAll('.js-reply');
var textEditor = document.querySelector('.js-textEditor');
reply.forEach(function (el) {
  el.addEventListener('click', function () {
    textEditor.classList.toggle('hidden');
  });
});
var jsEditRight = document.querySelector('.js-editRight');
var jsEditArrow = document.querySelector('.js-editorArrow');
var jsEditBottomSection = document.querySelector('.js-editButtonSection');
